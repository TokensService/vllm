...
def get_hisparse_kv_cache_config(
    ...
    KVCacheConfigBuilder.validate_kv_cache_layout(vllm_config, layout, device_groups)
    bytes_per_block = KVCacheConfigBuilder.get_pool_bytes_per_block(
        vllm_config, device_groups
    )
    ...
    KVCacheConfigBuilder.validate_kv_cache_layout(vllm_config, host_layout, host_groups)
    host_bytes_per_block = KVCacheConfigBuilder.get_pool_bytes_per_block(
        vllm_config, host_groups
    )
