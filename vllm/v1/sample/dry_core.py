...
def dry_core(
    ...
    # requests enabled DRY. That is a measurement, not an estimate: it was taken on the
    # first version of this file, added by "[Sampler] Add the DRY match computation".
    # Check out that commit and run the same script.
