...
Frontend helpers, shared by SamplingParams (breaker resolution) and the
sampler's DRY logits processor (vllm/v1/worker/gpu/sample/dry.py). The
match computation itself lives in vllm/v1/sample/dry_core.py.
"""
