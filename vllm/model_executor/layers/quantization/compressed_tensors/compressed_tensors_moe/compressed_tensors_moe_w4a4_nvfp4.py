...
class CompressedTensorsW4A4Nvfp4MoEMethod(CompressedTensorsMoEMethod):
    def __init__(
        ...
        if self.use_flashinfer_moe_ep:
            ...
            self.experts_cls: type[mk.FusedMoEExperts] | None = FlashInferMoeEpExperts
    ...
    def _process_flashinfer_moe_ep_weights(
        ...
        for name in (
            ...
            delattr(layer, name)
        self.moe_quant_config = FusedMoEQuantConfig.make("nvfp4", weight_dtype="nvfp4")
        self.moe_kernel = make_flashinfer_moe_ep_kernel(
            layer, self.moe, weights, epilogue, self.moe_quant_config
        )
