...
class FlashInferNVLinkOneSidedManager(All2AllManagerBase):
    ...
    def initialize(
        ...
        # must match the dtype combine_into() asks the kernel to send: fp8 is
        # 1 byte/elem, bf16 is 2. Under-sizing corrupts the combine buffer.
        combine_payload_size_per_token = (
            hidden_size if self.low_precision_combine else hidden_size * 2
        )
